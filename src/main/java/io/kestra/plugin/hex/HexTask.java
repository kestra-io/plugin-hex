    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.hex.HexTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class HexTask extends Task implements RunnableTask<HexTask.Output> {
    @Schema(
    ...
    @Override
    public HexTask.Output run(RunContext runContext) throws Exception {
